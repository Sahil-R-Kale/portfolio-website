...
export type PublicationEntry = { title: string; venue: string; year: string; url: string; contributions: string[] };
...
export const siteData = {
  ...
  bio: 'Hi! I am Sahil, an AI researcher focused on building trustworthy and reliable language models, with an emphasis on model self-knowledge, hallucination detection, and calibration under uncertainty. My work has been published at venues including NeurIPS, ACL, NAACL, and SIGIR, and I am currently pursuing an M.S. in Computer Science at UCLA following research and engineering roles at Mastercard and KnowledgeVerse AI. My main goal is to build AI systems that are powerful yet also trustworthy enough to actually help humans towards a more equitable future.\n\nI’m open to research collaborations and exploring AI research & engineering roles for 2027. Please reach out via email if you’d like to connect!',
  ...
  publications: [
  {
    title: 'Local Information Access in Marathi: Evaluating LLM-Native Web Retrieval in a Low-Resource Environment',
  ...
  },
  {
    ...
    venue: 'TrustAI Workshop @NAACL Conference 2025, Albuquerque, USA',
    year: '2025',
...
{
  title: 'Designing Policy with Last-Mile Stakeholders: Connecting Ground-Level Farmer Insights to Indian Agrarian Policymakers with NLP',
...
{
  title: 'Geospatial modeling study assessing population level accessibility to medical college hospitals in India',
...
{
  title: 'A secure and imperceptible communication system for sharing co-ordinate data',
...
{
  title: 'Assessing Population-level Accessibility to Medical College Hospitals in India: A Geospatial Modeling Study',
...
},
  {
    ...
    venue: 'Workshop on Scholarly Document Processing @ ACL 2025, Vienna, Austria',
    year: '2025',
  ...
  { year: 'Sep 2026', text: 'I was invited to present at the U&ME LLM Unlearning workshop at ECCV 2026 in Malmo, Sweden with a full €2000 grant.' },
  { year: 'Jul 2026', text: 'I presented my research at SIGIR 2026 in Melbourne on low resource LLM-native web retrieval with a $1500 grant.' },
  { year: 'Jun 2026', text: 'I was invited as a start-up representative for KnowledgeVerse AI at ICRA 2026 in Vienna, Austria with an $800 grant.' },
  { year: 'Jun 2026', text: 'Kasturi presented our work on AI-backed techniques to connect farmers with policymakers at ACM DIS 2026 in Singapore.'},
  { year: 'May 2026', text: 'Presented research at ACM WebSci 2026 in Braunschweig, Germany on LLM web search capabilities with a full $1,000 grant.' },
  { year: 'Apr 2026', text: 'My project placed 3rd in the Impact Achiever category at the Zurich GenAI Awards for a trustworthy AI system.' },
  ...
  { year: 'Mar 2026', text: 'Dr. Luca Alfeo presented our research at ICPRAM 2026 on using knowledge graphs to improve LLM hallucination self-detection.' },
  { year: 'Feb 2026', text: 'Spoke at the AAAI IASEAI Conference at UNESCO headquarters in Paris on how memorization can artificially inflate LLM self-knowledge.' },
  { year: 'Feb 2026', text: 'Our geospatial modeling study was published in Springer’s Discover Public Health journal.' },
  ...
  { year: 'Jul 2025', text: 'My abstract was selected at the Pre-ACL workshop in Copenhagen with a €200 award.' },
  { year: 'Jul 2025', text: 'Attended the Lisbon Machine Learning Summer School with a full $1,500 Google scholarship' },
  { year: 'Apr 2025', text: 'I presented research at the TrustAI workshop at NAACL 2025 in Albuquerque with a $350 grant.' },
